...
root.title("Secret Messaging Application")

# Input for message
Label(root, text="Enter Message:", font=("Helvetica", 12)).pack(pady=5)
text_input = Text(root, height=4, width=50)
text_input.pack(pady=5)

# Input for key
Label(root, text="Enter Encryption/Decryption Key:", font=("Helvetica", 12)).pack(pady=5)
key_input = Entry(root, show="#", width=50)
key_input.pack(pady=5)

# Buttons
Button(root, text="Encrypt", command=encrypt_message, bg="green", font=("Helvetica", 12)).pack(pady=10)
Button(root, text="Decrypt", command=decrypt_message, bg="red", font=("Helvetica", 12)).pack(pady=10)
